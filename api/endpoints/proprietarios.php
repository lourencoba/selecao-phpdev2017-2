...
$app->get('/proprietarios/{pro_int_codigo}/{apikey}', function (Request $request, Response $response) {
...
$app->post('/proprietarios/{apikey}', function (Request $request, Response $response) {
...
$app->put('/proprietarios/{pro_int_codigo}/{apikey}', function (Request $request, Response $response) {
    $body = $request->getParsedBody();
	$pro_int_codigo = $request->getAttribute('pro_int_codigo');
...
$app->delete('/proprietarios/{pro_int_codigo}/{apikey}', function (Request $request, Response $response) {
	$pro_int_codigo = $request->getAttribute('pro_int_codigo');
