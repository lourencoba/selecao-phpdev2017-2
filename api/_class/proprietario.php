...
class Proprietario{
	...
	public function getPro_dti_inclusao() {
		return $this->pro_dti_inclusao;
	}

	public function setPro_dti_inclusao($pro_dti_inclusao) {
		$this->pro_dti_inclusao = $pro_dti_inclusao;
	}
